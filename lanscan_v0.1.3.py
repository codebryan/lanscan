#!/usr/bin/env python3
"""
LAN Proxy Scanner v0.1.3 - 區域網路住宅代理節點偵測工具
  ...
  sudo python3 lanscan_v{VERSION}.py -o report.json
    ...
    for i, host in enumerate(hosts, 1):
        ...
        if open_ports is None:
            ...
            results.append({**host, "open_ports": {}, "risk": risk, "unreachable": True})
        else:
            risk = assess_risk(open_ports)
            results.append({**host, "open_ports": open_ports, "risk": risk, "unreachable": False})
